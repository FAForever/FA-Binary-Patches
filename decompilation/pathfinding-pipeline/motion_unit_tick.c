// Address: 0x6A9091 (within function at 0x6A9010)
// Function: Moho::Unit::MotionTick
// Layer 4 - Physics/Motion: Unit motion tick (same function as motion_tick.c)
// Note: 0x6A9091 is mid-function; IDA resolved to containing function at 0x6A9010
// The line at 0x6A9091 is: Moho::CUnitMotion::MotionTick(ADJ(this)->mUnitMotion)
